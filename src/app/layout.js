...
export const metadata = {
  ...
  keywords: ["laptops", "gaming laptops", "business laptops", "Pakistan", "computers"],
  authors: [{ name: "Laptops Official" }],
  openGraph: {
    title: "Laptops Official - Premium Gaming & Business Laptops",
    description: "Pakistan's premier destination for gaming laptops, business notebooks, and high-performance computers.",
    type: "website",
    locale: "en_US",
  },
  twitter: {
